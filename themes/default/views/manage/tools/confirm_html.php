<?php
/* ----------------------------------------------------------------------
 * themes/views/manage/tools/confirm_html.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<?php
				print _t("You are about to run <em>%1</em> in <em>%2</em>.");
?>			
			</div>
...
?>				
			...
			<div id="caConfirmBatchExecutionPanelControlButtons">
				<table>
					<tr>
						<td align="right"><?php print caJSButton($this->request, __CA_NAV_BUTTON_SAVE__, _t('Run tool'), 'caConfirmBatchExecutionFormExecuteButton', array('onclick' => 'caRunTool(); return false;'), array()); ?></td>
